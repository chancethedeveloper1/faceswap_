#!/usr/bin/env python3
"""
    The default options for the faceswap Match_Mean Color plugin.
...
_HELPTEXT = "Options for matching the mean of the pixel intensity of the original face"


_DEFAULTS = {
    "match-mean-colorspace": {
        "default": "LAB",
    ...
    "match-mean-overflow correction": {
        "default": "clip",
