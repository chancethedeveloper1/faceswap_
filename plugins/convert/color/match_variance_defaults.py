#!/usr/bin/env python3
"""
    The default options for the faceswap Match_Variance Color plugin.
...
_HELPTEXT = "Options for matching the mean, and variance of the pixel intensity of the original face"


_DEFAULTS = {
    "match-variance-colorspace": {
        "default": "LAB",
    ...
    "match-variance-overflow correction": {
        "default": "clip",
